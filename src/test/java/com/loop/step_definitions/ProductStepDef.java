...
public class ProductStepDef {
    ...
    public void user_should_be_able_to_see_expected_prices_in_following_products(List<Map<String, String>> productDetails) {                //list of string map we will uise
      ...
      for (Map<String,String> productDetail : productDetails){
          ...
          Assert.assertEquals("Expected does NOT match with Actual", expectedPrice, actualPrice);
