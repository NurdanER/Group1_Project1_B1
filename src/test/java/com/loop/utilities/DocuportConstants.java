...
public class DocuportConstants {            //here we with final and static I try to lock changing username
    ...
    public static final String EXPECTED_MESSAGE_FOR_EMPTY_USERNAME = "Please enter your username or email address";
